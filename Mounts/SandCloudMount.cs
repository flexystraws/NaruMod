...
namespace NaruMod.Mounts
{
    public class SandCloudMount : ModMountData
    {
        public override void SetDefaults()
        {
            mountData.buff = mod.BuffType("SandCloud Buff");
            ...
            mountData.xOffset = -6;
            mountData.yOffset = 28;          //how high is the mount from the player
